...
parser.add_argument('--upper', type=int, default=100, help='')
parser.add_argument('--lower', type=int, default=-100, help='')
...
parser.add_argument('--dataset_path',default = r'/content/fixed',help='fixed trainset root path')
#parser.add_argument('--dataset_path',default = r'/content/drive/MyDrive/3DUNet/raw_dataset/fixed_lits',help='fixed trainset root path')
parser.add_argument('--test_data_path',default = '/content/drive/MyDrive/3DUNet/raw_dataset/preprocessed_test',help='Testset path')
