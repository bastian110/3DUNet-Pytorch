...
class ResUNet(nn.Module):
    def __init__(self, in_channel=1, out_channel=2 ,training=True):
        ...
        self.map4 = nn.Sequential(
            ...
            nn.Upsample(scale_factor=(1,0.5*2, 0.5*2), mode='trilinear', align_corners=False),
            nn.Softmax(dim=1)
        )
        ...
        self.map3 = nn.Sequential(
            ...
            nn.Upsample(scale_factor=(2, 0.5*4, 0.5*4), mode='trilinear', align_corners=False),
            nn.Softmax(dim=1)
        )
        ...
        self.map2 = nn.Sequential(
            ...
            nn.Upsample(scale_factor=(4, 0.5*8, 0.5*8), mode='trilinear', align_corners=False),
        ...
        self.map1 = nn.Sequential(
            ...
            nn.Upsample(scale_factor=(8, 0.5*16, 0.5*16), mode='trilinear', align_corners=False),
            nn.Softmax(dim=1)
        )
